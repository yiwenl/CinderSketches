...
namespace alfrid {
	...
	namespace color {
		static vector<vector<int>> mColorThemes = {
		...
		static vector<vec3> getColorTheme() {
			int index = rand() % mColorThemes.size();
			CI_LOG_D("index " <<  index << ", "<< mColorThemes.size() );
			vector<int> hexValues = mColorThemes.at(index);
