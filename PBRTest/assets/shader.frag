...
{
	float mipCount = 6.0; // resolution of 512x512
	...
	#ifdef USE_TEX_LOD
		vec3 specularLight = SRGBtoLINEAR(textureLod(uRadianceMap, reflection, lod)).rgb;
...
void main() {
	...
	// oColor = vec4(vec3(uRoughness, uMetallic, 0.0), 1.0);
